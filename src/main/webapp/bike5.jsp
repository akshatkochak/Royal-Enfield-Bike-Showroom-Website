...
<body>
    ...
    <script>
        ...
        redBtn.onclick = function(){
            ...
            bike.style.backgroundImage = "url(project-images/meteor350/meteor350supernovared.jpeg)";

        }

        blueBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/meteor350/meteor350supernovasilvercustom.jpeg)";

        }

        blackBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/meteor350/meteor350supernovablue.jpeg)";
