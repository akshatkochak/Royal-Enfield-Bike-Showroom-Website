...
<body>
    ...
    <script>
        ...
        redBtn.onclick = function(){
            ...
            bike.style.backgroundImage = "url(project-images/supermetero650/supermeteor650celestialred.png)";

        }

        blueBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/supermetero650/supermeteor650interstellargrey.png)";

        }

        blackBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/supermetero650/supermeteor650astralblue.png)";
