...
<body>
    ...
    <script>
        ...
        redBtn.onclick = function(){
            ...
            bike.style.backgroundImage = "url(project-images/intercepeter650/interceptor650canyonred.jpeg)";

        }

        blueBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/intercepeter650/interceptor650downtowndrag.jpeg)";

        }

        blackBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/intercepeter650/interceptor650barcelonablue.png)";
