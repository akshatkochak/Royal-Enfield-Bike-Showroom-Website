...
<body>
    ...
    <script>
        ...
        redBtn.onclick = function(){
            ...
            bike.style.backgroundImage = "url(project-images/scram411/scram411graphitered.jpeg)";

        }

        blueBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/scram411/scram411whiteflame.jpeg)";

        }

        blackBtn.onclick = function(){

            bike.style.backgroundImage = "url(project-images/scram411/scram411skylineblue.jpeg)";
